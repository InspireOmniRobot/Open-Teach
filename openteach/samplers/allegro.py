...
class KinovaSampler_old(Sampler):
    ...
    def _get_robot_data(self):
        ...
        self._kinova_states = np.concatenate(
    ...
    def kinova_data(self):
        ...
        print(len(self.positions))
        np.save(
            self.data_path / "processed_1" / "kinova_states_new.npy",
    ...
    def sample_data(self):
        ...
        for current_idx in tqdm(
            ...
            if get_distance(current_state, previous_state) > self._min_action_distance:
                ...
                allegro_idx = self._get_matching_timestamp(
                    self._allegro_timestamps, current_timestamp
                )
